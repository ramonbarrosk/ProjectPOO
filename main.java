      ...
      while(option_menu!=4){
        ...
        switch(op_menu){
          ...
          case 2:
            ...
            scan.nextLine();
            User user = new User(new_name, new_type);
          ...
          case 3:
            ...
            for (User find_user : users) {
              if(find_user.name.equals(username_find)){
        ...
        switch(option){
          case 1:
            ...
            if (option==1){
              ...
              System.out.print("Informe o período da bolsa: ");
              String scholarship_period = scan.nextLine();
              Project project = new Project(description, datetime_begin_input, datetime_end_input, cordinator, scholarship_period);
              ...
              if (option_edit==1){
                ...
                String new_date_begin = scan.nextLine();
                project.setDatetimeBegin(new_date_begin);
                ...
                String new_date_end = scan.nextLine();
                project.setDatetimeEnd(new_date_end);
                ...
                System.out.print("Digite o novo período da bolsa: ");
          ...
          case 2:
            ...
            if (option==1){
              ...
              if (option_edit==1){
                ...
                System.out.print("Digite a nova data de início: ");
                String new_date_begin = scan.nextLine();
                activity.setDatetimeBegin(new_date_begin);
                System.out.println("Data de início atualizada com sucesso!");
              }  
              else if (option_edit==3){
                System.out.print("Digite a nova data de término: ");
                String new_date_end = scan.nextLine();
                activity.setDatetimeEnd(new_date_end);
                System.out.println("Data de término atualizada com sucesso!");
              }  
              else if (option_edit==4){
                list_users(users, "Professor");
